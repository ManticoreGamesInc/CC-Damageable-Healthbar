...
Interested in contributing to CC-Damageable-Healthbar? Want to report a bug?
...
[2]: https://github.com/ManticoreGamesInc/CC-Damageable-Healthbar
...
3. **Pull Request**: After making sure everything passes, commit your changes,
   push your branch to GitHub and send a PR to `ManticoreGamesInc/CC-Damageable-Healthbar:main`.
