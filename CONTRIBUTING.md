...
[2]: https://github.com/ManticoreGamesInc/Bootcamp-Damageable-Healthbar
...
3. **Pull Request**: After making sure everything passes, commit your changes,
   push your branch to GitHub and send a PR to `ManticoreGamesInc/Bootcamp-Damageable-Healthbar:main`.
